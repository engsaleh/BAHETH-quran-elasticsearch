...
### Quran Advanced Search Engine with Elasticsearch

تطبيق ويب احترافي للبحث الذكي في القرآن الكريم يجمع بين قوة Elasticsearch 9.1.4 وتقنيات الذكاء الاصطناعي لتوفير تجربة بحث متقدمة بثلاثة أنماط: اللغوي، الدلالي، والهجين.
